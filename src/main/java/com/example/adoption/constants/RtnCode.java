...
public enum RtnCode {
	...
	CHANGE_PASSWORD_ERROR(400, "Change password error!!"), FORGOT_PASSWORD_ERROR(400, "Forgot password error!!"), //
	...
	FORUM_NOT_FOUND(400, "FORUM_NOT_FOUND"), //
	POST_NOT_FOUND(400, "POST_NOT_FOUND"), //
	ALREADY_LIKED(400, "ALREADY_LIKED");//
